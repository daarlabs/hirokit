...
func FormatSql(value string) string {
	...
	value = strings.ReplaceAll(value, " IS", highlightSql(" IS"))
	value = strings.ReplaceAll(value, " NOT", highlightSql(" NOT"))
	value = strings.ReplaceAll(value, " NULL", highlightSql(" NULL"))
